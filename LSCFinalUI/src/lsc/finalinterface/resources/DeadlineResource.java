...
public class DeadlineResource {
	...
	public Deadline getById() {
		return FinalInterfaceLogic.deadline.getById(uriInfo, deadline_id);
	}
	...
	public Deadline put(Deadline deadline) {
		return FinalInterfaceLogic.deadline.put( uriInfo, deadline, deadline_id );
	}
	
	@DELETE
	public void delete() {
		FinalInterfaceLogic.deadline.delete( uriInfo, deadline_id );
	}
