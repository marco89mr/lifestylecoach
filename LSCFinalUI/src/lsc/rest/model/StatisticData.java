...
public class StatisticData extends Base {
	...
	*/
	...
	public static float sum(List<StatisticData> datas) {
		float sum = 0;
	...
	public static float average(List<StatisticData> datas) {
		float sum = 0;
		for(StatisticData d : datas){
			sum =+ Float.parseFloat( d.getValue() );
		}
	...
	public static StatisticData max(List<StatisticData> datas) {
		StatisticData max = null;
		for(StatisticData d : datas)
	...
	public static StatisticData min(List<StatisticData> datas) {
		StatisticData min = null;
		for(StatisticData d : datas)
