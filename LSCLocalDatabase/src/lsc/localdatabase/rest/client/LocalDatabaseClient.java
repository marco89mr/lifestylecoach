...
public class LocalDatabaseClient {
	...
	public static abstract class BaseClient<M extends Base, MM extends BaseCollection<M>, F extends LocalDatabaseFilter.BaseFilter > {
	...
	public static class UserClient extends BaseClient<User, UserCollection, LocalDatabaseFilter.UserFilter> {		
		@Override
	...
	public static class RecordClient extends BaseClient<Record, RecordCollection, LocalDatabaseFilter.RecordFilter> {			
		@Override
		protected Class<Record> model_class() { return Record.class; }
		@Override
		protected Class<RecordCollection> model_collection_class() { return RecordCollection.class; }
		@Override
		public String resource_url() { return main_url() + "/record"; }		
	}
	public static class DataClient extends BaseClient<Data, DataCollection, LocalDatabaseFilter.DataFilter> {			
		@Override
	...
	public static class GoalClient extends BaseClient<Goal, GoalCollection, LocalDatabaseFilter.GoalFilter> {
		@Override
	...
	public static class DeadlineClient extends BaseClient<Deadline, DeadlineCollection, LocalDatabaseFilter.DeadlineFilter> {
		@Override
	...
	public static class ToDoClient extends BaseClient<ToDo, ToDoCollection, LocalDatabaseFilter.ToDoFilter> {
		@Override
	...
	public static class NotificationClient extends BaseClient<Notification, NotificationCollection, LocalDatabaseFilter.NotificationFilter> {
		@Override
